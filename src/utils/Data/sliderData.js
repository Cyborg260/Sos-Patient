export const sliderData = [
    {
        ...
        docImage: require("../../assets/images/nur1.png"),
        txt: " Let's start living \n healthy & well with \nus right now!",
        detail: "We can recommend you best specialist\n for your health so he can help out you\n in your medical issues."
    },
    {
        id: 1,
        dotsImage: require("../../assets/images/GroupDot.png"),
    ...
    },
    {
        id: 2,
        dotsImage: require("../../assets/images/GroupDot.png"),
        docImage: require("../../assets/images/nur2.png"),
        txt: " Get Instant Consult\nFrom Your Preferred\n Doctor",
        detail: "Now you can speak to your preferred doctor\n within 1 minute through chat/voice call/\n video call"
    },
    {
        id: 3,
        dotsImage: require("../../assets/images/GroupDot.png"),
